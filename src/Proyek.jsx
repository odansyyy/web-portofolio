...
function Proyek () {
    return(
        <section class="bg-amber-100/25 text-gray-600 body-font overflow-hidden">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Projek</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Beberapa projek projek yang saya dapatkan selama ini.</p>
