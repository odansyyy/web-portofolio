...
function Banner () {
    ...
    return (
    <>
        <div data-aos="fade-right"className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg-text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center">
            <div data-aos="fade-left" className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi aliquid necessitatibus corrupti autem, harum rerum temporibus iure quas, consequatur eos reiciendis eligendi pariatur provident tempora et, cumque fugiat! Veritatis, cum!</p>
